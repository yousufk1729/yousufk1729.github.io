...
**Truth-functional connective:** Operators that combine or modify simple sentences, such as NOT, OR, AND, and implication.
...
**Validity:** An argument is (classically) valid iff there is no logically possible situation in which its premises are true and its conclusion is false.
...
featuring some connective (normally just the rightmost column) is determined by the truth-
